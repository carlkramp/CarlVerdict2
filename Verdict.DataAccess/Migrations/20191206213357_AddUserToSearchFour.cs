...
{
    public partial class AddUserToSearchFour : Migration
    {
        ...
        //                onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwitterUser = table.Column<string>(nullable: false),
                    HoursAgo = table.Column<int>(nullable: false),
                    TweetLink = table.Column<string>(nullable: false),
